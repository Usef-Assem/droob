        ...
        <>
            ...
            <div className="container py-5" dir="rtl" style={{ maxWidth: '1000px' }} id="reading-guides-content">
                ...
                <header className="text-center mb-5">
                    ...
                    <h3 className="text-secondary">(صعوبات تعلم القراءة)</h3>
                    ...
                    <div className="card-body">
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                عزيزي المُعلّم إليك مجموعة من التوجيهات التعليمية التي تساعدك في التعامل مع تلميذك من ذوي صعوبات تعلم القراءة .
                            </li>
                            <li className="list-group-item">
                ...
                <section className="card mb-4 shadow">
                    <div className="card-body">
                        <h2 className="card-title text-primary mb-4">التوجيهات التعليمية المرتبطة بصعوبات تعلم القراءة</h2>
